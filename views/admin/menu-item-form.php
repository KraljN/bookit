              ...
              <div class="card" id="menu-item-add-form">
                ...
                <div class="card-body">
                  <form action="obrada.php" method="POST">
                    ...
                    <input type="submit" class="btn btn-primary float-right mt-3" id="<?php if(isset($_GET["id"])) echo("edit-menu-submit"); else echo ("add-menu-submit") ?>" value="<?php if(isset($_GET["id"])) echo("Edit"); else echo ("Add") ?>"/>
