<?php if(isset($_GET["action"]) && $_GET["action"] == "getUsers"){
        ...
        $query = "SELECT p.first_name AS name, p.last_name AS surname, u.username, u.addres, c.city_name, co.country_name, u.active, u.user_id AS id, u.email, r.role_name AS role 
