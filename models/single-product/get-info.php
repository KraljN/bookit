<?php 
    if(isset($_GET["id"])){
        ...
        $prepare = $db->prepare("SELECT b.book_id AS id, bi.path, bi.alt, b.title, p.value AS price, b.description, b.publication_year, per.first_name, per.last_name, pub.publisher_name, b.number_of_pages AS pages 
